...
const uint8_t* as_flat_unpack_record_meta(const as_flat_record* flat, const uint8_t* end, struct as_flat_opt_meta_s* opt_meta);
...
bool as_flat_skip_bins(const as_flat_comp_meta* cm, struct as_storage_rd_s* rd);
